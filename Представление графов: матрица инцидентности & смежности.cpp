/*
1. Розробити структури даних для подання неорієнтованого та орієнтованого
графів за різними методам (обравши певну мову програмування):
− матрицею інцидентності;
− матрицею суміжності.
Порівняти особливості і переваги кожного варіанту подання графів..
2. Розробити функції уводу та виводу даних, що визначають граф, у ці структури.
*/
