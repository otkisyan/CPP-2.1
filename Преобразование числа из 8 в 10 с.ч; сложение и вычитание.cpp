...
1. Розробіть мовою програмування C/С++ функції перетворення числа з
однієї системи числення в іншу відповідно до варіанту. Числа задавати
та отримувати у вигляді рядка.
